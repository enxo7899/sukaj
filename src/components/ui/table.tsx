...
>(({ className, ...props }, ref) => (
  <div className="relative w-full rounded-2xl border border-border/15 bg-card/15 shadow-lg shadow-black/10">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "sticky top-0 z-30 bg-card/70 backdrop-blur-md [&_tr]:border-b [&_tr]:border-border/20",
      className
    )}
    {...props}
  />
